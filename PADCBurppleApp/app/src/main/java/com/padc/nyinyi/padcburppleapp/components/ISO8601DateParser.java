package com.padc.nyinyi.padcburppleapp.components;
...
public class ISO8601DateParser {
    ...
    public static String getFormattedDate(Context context, String date) {
        ...
        try {
            ...
            tmp = st.nextToken() + " " + context.getResources().getStringArray(R.array.month_array)[Integer.parseInt(st.nextToken()) - 1] + " " + st.nextToken();
            return tmp;
    ...
    public static String getFormattedDateAndTime(Context context,String date) {
        return ISO8601DateParser.getFormattedDate(context, date) + " at " + ISO8601DateParser.getFormattedTime(date);
    }
